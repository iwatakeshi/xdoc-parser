...
import * as Lexer from './src/XDocLexer';
import * as Parser from './src/XDocParser';
import * as _ from 'lodash';

export class XDoc {
  private parser: Parser.XDocParser
  constructor(source: string) {
    this.parser = new Parser.XDocParser(new CommonTokenStream(
      new Lexer.XDocLexer(
